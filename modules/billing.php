	...
	class Billing_Module extends Module_Skeleton {
		...
		public function get_next_payment() {
	     ...
	     private function _get_paypal_next_payment($subscription)
	     {
			...
			$row  = $rs->fetch_object();
			$term1 = $row->initial_term; $termt1 = $row->initial_term_type;
			$termp1  = $row->initial_price; $termp2 = $row->recurring_price;
			$term2 = $row->recurring_term; $termt2 = $row->recurring_term_type;
			$date_signup = $row->date_signup; $last_payment = $row->last_payment;
