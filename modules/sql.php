<?php
	...
	class Sql_Module extends Module_Skeleton {
		...
		public function add_mysql_backup ($db, $extension = "zip", $span = 5, $preserve = '0', $email = '') { return $this->add_sql_backup('mysql',$db, $extension, $span, $preserve, $email); }
		public function add_pgsql_backup ($db, $extension = "zip", $span = 5, $preserve = '0', $email = '') { return $this->add_sql_backup('pgsql',$db, $extension, $span, $preserve, $email); }
		public function edit_mysql_backup($db, $extension, $span = '0', $preserve = '0', $email = '') { return $this->edit_sql_backup('mysql',$db, $extension, $span, $preserve, $email); }
		public function edit_pgsql_backup($db, $extension, $span = '0', $preserve = '0', $email = '') { return $this->edit_sql_backup('mysql',$db, $extension, $span, $preserve, $email); }
		public function list_mysql_backups() { return $this->list_sql_backups('mysql'); }
		public function list_pgsql_backups() { return $this->list_sql_backups('pgsql'); }
		 ...
		 * @return bool
		 */
		public function delete_mysql_backup($db) { return $this->delete_sql_backup('mysql',$db); }
		// }}}
		 ...
		 * @return bool
		 */
		public function delete_pgsql_backup($db) { return $this->delete_sql_backup('pgsql',$db); }
		// }}}
